namespace Terrasoft.Core.Process
{
	...
	#region Class: BalCreateRealtyVisitClassicProcessMethodsWrapper

	/// <exclude/>
	public class BalCreateRealtyVisitClassicProcessMethodsWrapper : ProcessModel
	{

		public BalCreateRealtyVisitClassicProcessMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			String sender = "CreateRealtyVisitClassicProcess";
